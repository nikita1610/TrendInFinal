...
public class MainCameraActivity extends Activity {
    ...
    private static final String APP_KEY = "ftgrabi7y2lewwn";
    private static final String APP_SECRET = "q3ydpq1vqxm54fq";
        ...
        mRoulette.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                DownloadPicture download = new DownloadPicture(
                        MainCameraActivity.this, mApi, PHOTO_DIR, mImage);
                download.execute();
            }
        });
