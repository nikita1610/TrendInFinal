    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hover4.findViewById(R.id.mail).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "About TrendIn");
                emailIntent.putExtra(android.content.Intent.EXTRA_TEXT, "I have a good idea for this app..");
